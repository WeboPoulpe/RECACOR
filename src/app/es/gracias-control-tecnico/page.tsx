...
export const metadata: Metadata = {
  ...
  description: "Confirmación de solicitud de ITV / control técnico Recacor.",
  ...
  return (
    <section className="min-h-[70vh] bg-[linear-gradient(180deg,#061A31_0%,#2E2D8A_55%,#F6F7FB_100%)] px-4 pb-24 pt-36 text-center text-white">
      <div className="mx-auto max-w-2xl rounded-[4px] bg-white p-8 text-slate-950 shadow-xl sm:p-12">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">Gracias. El taller revisará tu solicitud y te contactará para confirmar la gestión de la ITV.</p>
